            ...
            <div class="grid grid-cols-1 lg:grid-cols-[0.92fr_1.08fr]">
                <div class="hidden lg:flex flex-col justify-between compact-desktop side-panel p-8 xl:p-10">
                    <div>
                        ...
                        <div class="mt-10 xl:mt-14">
                            <div class="relative w-20 h-20 xl:w-24 xl:h-24 rounded-[28px] icon-box flex items-center justify-center shadow-[0_0_55px_rgba(59,130,246,0.25)]">
                                <i class="fas fa-lock text-3xl xl:text-4xl"></i>
                            ...
                            <p class="mt-4 text-sm muted leading-7 max-w-sm">
                                Crea una contraseña segura para recuperar el acceso al Observatorio Max Schreier.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-4 mt-8">
                        <div class="flex items-center gap-3 muted text-xs font-bold">
                            ...
                            Token de recuperación verificado
                        </div>
                        <div class="flex items-center gap-3 muted text-xs font-bold">
                            <div class="w-8 h-8 rounded-xl icon-box flex items-center justify-center">
                                <i class="fas fa-user-shield text-[11px]"></i>
                            </div>
                            Actualización segura de acceso
                        </div>
                        <div class="flex items-center gap-3 muted text-xs font-bold">
                            <div class="w-8 h-8 rounded-xl icon-box flex items-center justify-center">
                ...
                <div class="p-5 sm:p-7 lg:p-8 xl:p-10 compact-desktop flex flex-col justify-center">
                    <div class="lg:hidden text-center mb-6">
                        ...
                        <h2 class="font-black text-[24px] uppercase tracking-widest">Nueva contraseña</h2>
                    ...
                    <div class="hidden lg:block mb-7">
                        <h2 class="font-black text-2xl uppercase tracking-widest">Restablecer acceso</h2>
                        <p class="muted text-xs mt-2">Completa los datos para guardar tu nueva contraseña.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
                        ...
                        <div>
                            <label for="password" class="block text-[10px] font-black muted uppercase tracking-widest mb-2">
                                Nueva contraseña
                            </label>
                            <div class="relative">
                                <i class="fas fa-lock absolute left-4 top-1/2 -translate-y-1/2 muted text-xs"></i>
                                <input id="password" type="password" name="password" required autocomplete="new-password" placeholder="••••••••"
                                    class="input-box w-full rounded-2xl pl-10 pr-12 py-3.5 text-sm">
                        ...
                        <div>
                            <label for="password_confirmation" class="block text-[10px] font-black muted uppercase tracking-widest mb-2">
                                Confirmar contraseña
                            </label>
                            <div class="relative">
                                <i class="fas fa-check-double absolute left-4 top-1/2 -translate-y-1/2 muted text-xs"></i>
                                <input id="password_confirmation" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="••••••••"
                                    class="input-box w-full rounded-2xl pl-10 pr-12 py-3.5 text-sm">
                                <button type="button" onclick="togglePasswordVisibility('password_confirmation', 'passwordConfirmationIcon')"
                                    class="absolute right-4 top-1/2 -translate-y-1/2 transition"
                                    style="color: var(--muted);" title="Mostrar u ocultar contraseña">
                                    <i id="passwordConfirmationIcon" class="fas fa-eye text-xs"></i>
                                </button>
                            </div>
                        </div>
